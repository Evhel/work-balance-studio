...
function makeEmployees(): Employee[] {
  const rows: [string, string, string, string, Employee["position"], boolean][] = [
    ["Иванов", "Иван", "Иванович", "ГИП", "Директор", true],
    ["Петрова", "Анна", "Сергеевна", "Офис", "Офис-менеджер", true],
    ["Сидоров", "Пётр", "Алексеевич", "АР", "Руководитель отдела", true],
    ["Кузнецова", "Мария", "Ивановна", "КР", "Сотрудник", true],
    ["Смирнов", "Олег", "Дмитриевич", "ОВ", "Сотрудник", false],
    ["Волкова", "Елена", "Павловна", "ГИП", "Сотрудник", true],
    ["Морозов", "Артём", "Юрьевич", "ЭОМ", "Модератор", true],
    // АР +4
    ["Ковалёв", "Денис", "Олегович", "АР", "Сотрудник", true],
    ["Никитина", "Юлия", "Андреевна", "АР", "Сотрудник", true],
    ["Романов", "Кирилл", "Игоревич", "АР", "Сотрудник", true],
    ["Белова", "Дарья", "Максимовна", "АР", "Сотрудник", true],
    // КР +4 (один руководитель)
    ["Захаров", "Михаил", "Петрович", "КР", "Руководитель отдела", true],
    ["Орлова", "Светлана", "Викторовна", "КР", "Сотрудник", true],
    ["Тимофеев", "Роман", "Сергеевич", "КР", "Сотрудник", true],
    ["Лебедев", "Антон", "Валерьевич", "КР", "Сотрудник", true],
    // ГИП +4 (один руководитель)
    ["Григорьев", "Сергей", "Николаевич", "ГИП", "Руководитель отдела", true],
    ["Фомина", "Ирина", "Олеговна", "ГИП", "Сотрудник", true],
    ["Егоров", "Владимир", "Ильич", "ГИП", "Сотрудник", true],
    ["Соколова", "Наталья", "Юрьевна", "ГИП", "Сотрудник", true],
    // BIM руководитель
    ["Панкратов", "Алексей", "Викторович", "BIM", "Руководитель отдела", true],
  ];
  return rows.map((r, i) => ({
    id: `e${i + 1}`,
    lastName: r[0],
